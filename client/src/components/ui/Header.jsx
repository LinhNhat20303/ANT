    ...
    >
      ...
      >
        <a href="/" className="flex items-center gap-1">
          <img
            className="h-14 w-auto md:h-16" // Updated for bigger size
            src="../assets/Group 47.png" // Make sure the path is correct for your logo file
            alt="ANT Logo"
          />
          {/* Uncomment and update the site name if needed */}
