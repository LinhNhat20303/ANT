  ...
  return (
    <>
      <div className="flex w-4/6 overflow-hidden rounded-full border border-gray-400 bg-gray-300 shadow-sm hover:shadow-lg md:w-1/2">
        ...
        <div className="bg-blue flex cursor-pointer items-center bg-[#10270C] text-white">
          <button
            className="flex rounded-r-full bg-[#10270C]  px-4 py-2 md:p-2" // Updated background color
          ...
          >
            ...
            <span className="ml-1 hidden md:block">Tìm kiếm</span>
          </button>
        </div>
      </div>
    </>
